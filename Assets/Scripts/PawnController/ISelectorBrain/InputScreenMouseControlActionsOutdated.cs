...
// public class InputScreenMouseControlActionsOutdated : MonoBehaviour
// {
...
//     public (Vector3 worldPoint, Vector2 screenPoint, ScreenCastHitResult hit) GetMoveSelectionValue()
//     {
//         Vector2 mousePosition = Mouse.current.position.ReadValue();
//         Ray ray = Camera.main.ScreenPointToRay(mousePosition);
//         RaycastHit hit;
...
//         {
//             return (hit.point, mousePosition, ScreenCastHitResult.FloorHit);
//         }
...
//             return (intersection, mousePosition, ScreenCastHitResult.ZeroPlaneHit);
//         }
//         return (Vector3.zero, mousePosition, ScreenCastHitResult.NoHit);
//     }

//     public (Vector3 worldPoint, Vector2 screenPoint, ScreenCastHitResult hit) GetShootSelectionValue()
//     {
//         Vector2 mousePosition = Mouse.current.position.ReadValue();
//         Ray ray = Camera.main.ScreenPointToRay(mousePosition);
//         RaycastHit hit;
...
//         {
//             return (hit.point, mousePosition, ScreenCastHitResult.PawnHit);
//         }
//         (Vector3 worldPoint2, Vector2 _, ScreenCastHitResult hit2) = GetMoveSelectionValue();
//         if (hit2 != ScreenCastHitResult.NoHit)
//         {
//             return (worldPoint2, mousePosition, ScreenCastHitResult.FloorHit);
//         }
//         return (Vector3.zero, mousePosition, ScreenCastHitResult.NoHit);
//     }

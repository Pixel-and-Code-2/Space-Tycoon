...
// public class PawnControllerOutdated : MonoBehaviour
// {
//     public static PawnControllerOutdated Instance { get; private set; }
...
//         if (controlType == ControlType.walk)
//         {
//             (Vector3 worldPoint, Vector2 screenPoint, ScreenCastHitResult hit) = selector.GetMoveSelectionValue();
...
//         else if (controlType == ControlType.shoot)
//         {
//             (Vector3 worldPoint, Vector2 screenPoint, ScreenCastHitResult hit) = selector.GetShootSelectionValue();
//             if (hit != ScreenCastHitResult.NoHit)
//             {
